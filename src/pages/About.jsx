          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            ...
            <div>
              <h1 className="text-2xl font-bold mb-4">
                Qu<span className=" text-blue-300">a</span>lcosa su di Me...
              </h1>
              <p className=" ml-4">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  Ed<span className=" text-blue-300">u</span>cazione
                </h2>
                <ul className="">
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4">
                  Es<span className=" text-blue-300">p</span>erienze lavorative
                </h2>
                <ul>
                  ...
                  <li className=" mb-2 ml-4 list-disc text-xl">
                    Sikani Resort & SPA - Demi chef Antipasti
                  </li>
                  <span className="ml-4 text-lg">
